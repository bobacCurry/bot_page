  ...
  <div>
    <Modal
      ...
      <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
        <FormItem label="广告ID" prop="ads">
          <Input v-model="formValidate.ads._id" disabled placeholder="请选择广告"></Input>
        ...
        <FormItem label="购买时长" prop="day">
          <Input v-model="formValidate.day" type="number" number placeholder="请填写购买时长"></Input>
        </FormItem>
        <FormItem label="备注" prop="memo">
          <Input v-model="formValidate.memo" placeholder="请填写备注"></Input>
        </FormItem>
      </Form>
      <div slot="footer">
...
<script>
  ...
  export default {
    ...
    data () {
      const adsCheck = (rule, value, callback) => {
        if (!this.formValidate.ads._id) {
      ...
      return {
        ...
        ruleValidate: {
          ads: [
            { validator: adsCheck, trigger: 'blur' }
          ],
          day: [
